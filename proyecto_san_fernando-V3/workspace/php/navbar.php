...
<nav class="navbar navbar-inverse nav" role="navigation">
    ...
    <div class="collapse navbar-collapse navbar-ex1-collapse">
      <ul class="nav navbar-nav">
        <li><a class="navbar-brand" href="vista/admin.php"><b>TECNICO</b></b></a></li>
        <li><a href="../ver.php" class="navbar-brand2 glyphicon glyphicon-calendar"> Cronograma</a></li>
        <li><a href="../ver4.php" class="avisos glyphicon glyphicon-fire"> Avisos</a></li>
        <li><a href="" class="graficos glyphicon glyphicon-print" name="imprimir" onclick="window.print();"> Imprimir</a></li>
        
        <form class="navbar-form navbar-right navbar-brand5" role="search" action="./buscar3.php">
