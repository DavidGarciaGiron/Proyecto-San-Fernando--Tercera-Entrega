...
<nav class=" navbar navbar-inverse nav" role="navigation">
    ...
    <div class="collapse navbar-collapse navbar-ex2-collapse">
      ...
      <ul class="nav navbar-nav">
        ...
        <li><a href="../ver3.php" class="navbar-brand2 glyphicon glyphicon-calendar"> Cronograma</a></li>
        <li><a href="../ver6.php" class="avisos glyphicon glyphicon-fire"> Avisos</a></li>
        <li><a href="../ver7.php" class="graficos glyphicon glyphicon-stats"> Graficos</a></li>
        <li><a href="" class="graficos glyphicon glyphicon-print" name="imprimir" onclick="window.print();"> Imprimir</a></li>
        
        
        <form class="navbar-form navbar-right navbar-brand5" role="search" action="./buscar1.php">
