...
<?php if($query->num_rows>0):?>
	...
	<tbody class="tbody">
		<tr>
			...
			<td class="td"><a href="./editar.php?id=<?php echo $r["id"];?>"><img class="editar" src="https://pngimage.net/wp-content/uploads/2018/06/icono-editar-png-3.png" alt="editar"></a></td>
