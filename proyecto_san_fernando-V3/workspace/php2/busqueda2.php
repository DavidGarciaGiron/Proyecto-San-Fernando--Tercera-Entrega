		...
		<table>
			...
			<tbody class="tbody">
				<tr>
					...
					<td><a href="./editar5.php?id=<?php echo $r["id"];?>"><img class="editar" src="https://pngimage.net/wp-content/uploads/2018/06/icono-editar-png-3.png" alt="editar"></a></td>
					...
					<script>
						$("#del-"+<?php echo $r["id"];?>).click(function(e)	{
							...
							if(p)	{
								window.location="./php2/eliminar2.php?id="+<?php echo $r["id"];?>;
							}
						});
					</script>
				</tr>
