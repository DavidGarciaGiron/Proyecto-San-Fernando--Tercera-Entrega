	...
	<body>
			...
			<div class="starter-template">
					...
					<div class="container text-center">
						<h1><strong>Bienvenido</strong><br>
						<spam class="nombre_usuario"><?php echo $_SESSION["usuario"]["nombre"];?></spam></h1>
						<br><br>
						<p>Panel de control | <span class="label">Lider</span></p>
